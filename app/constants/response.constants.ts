...
export const SUCCESS_RESPONSES = {
    ...
    DELETED : new MessageHandler(SUCCESS_CODES.DELETED,SUCCESS_MESSAGE.DELETED_MESSAGE),
    UPDATED : new MessageHandler(SUCCESS_CODES.UPDATED,SUCCESS_MESSAGE.UPDATED_MESSAGE)
}
